    ...
    <div class="card">
      ...
      <form action="resto_login.php" method="post">
        <div class="form-group">
          <p class="text=center" style="font-size: 25px; font-weight: bold; color: #000000;">Restaurants Login</p>
        ...
        <button type="submit" class="btn btn-primary mt-4" style="font-weight: bold;
